...
const FAQItem: React.FC<Props> = ({ introText,
                                               step1Text,
                                               step2Text,
                                               step3Text,
                                               step4Text,
    ...
    return (
        <div className={"[ FAQItemComponent ]"}>
            <div className={"FAQItemComponent__Wrapper    { margin-bottom-l }"}>
                <div className={"[ FAQItemComponentText ]    { margin-left-s h2 font-statewideBold }"}>
                ...
                <img className={"[ FAQItemComponentVisual ]"} src={image}></img>
            </div>
        </div>
    );
}
